...
workflow AddPublicIPAndNSGToGroup {
    ...
    $AutomationAccountName = "AmoriniAuto" #Fill this up with you Azure Automation Account Name
    $AutomationAccountRg = "AmoriniRG"	#Fill this up with you Azure Automation Account Resource Group
    ...
    foreach($VMID in $VMinfo)
    {
        ...
        if( !(($VM -eq $Null) -Or ($VM.ResourceGroupName -eq $Null) -Or ($VM.RoleName -eq $Null))) {
            ...
            InlineScript { 
                ...
                $NicArmObject = Get-AzureRmResource -ResourceId $azurevm.NetworkProfile[0].NetworkInterfaces.id
